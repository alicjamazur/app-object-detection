            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.getItem(oldKey)];
                    case 4:
                        item = _c.sent();
                        return [4 /*yield*/, react_native_1.AsyncStorage.setItem(newKey, item)];
                    case 5:
                        _c.sent();
                        return [4 /*yield*/, react_native_1.AsyncStorage.removeItem(oldKey)];
                    case 6:
                        _c.sent();
                        ulid = newUlid;
                        return [3 /*break*/, 8];
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.multiRemove(keysForCollectionEntries)];
                    case 15:
                        _c.sent();
                        _c.label = 16;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.setItem(itemKey, JSON.stringify(item))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.multiGet(allItemsKeys)];
                    case 1:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                react_native_1.AsyncStorage.multiRemove(keysToDeleteArray, function (errors) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                react_native_1.AsyncStorage.multiSet(entriesToSet, function (errors) {
                                    if (errors && errors.length > 0) {
                                        reject(errors);
                                    }
                                    else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.getItem(itemKey)];
                    case 1:
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.multiGet(keysForStore)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.removeItem(itemKey)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, react_native_1.AsyncStorage.multiRemove(allDataStoreKeys)];
                    case 2:
                        _a.sent();
                        this._collectionInMemoryIndex.clear();
                        return [2 /*return*/];
