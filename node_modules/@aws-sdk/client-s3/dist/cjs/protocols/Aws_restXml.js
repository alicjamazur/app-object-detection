...
exports.serializeAws_restXmlDeleteObjectCommand = async (input, context) => {
    const headers = Object.assign(Object.assign(Object.assign({ "Content-Type": "" }, (isSerializableHeaderValue(input.BypassGovernanceRetention) && {
...
exports.serializeAws_restXmlDeleteObjectsCommand = async (input, context) => {
    const headers = Object.assign(Object.assign(Object.assign({ "Content-Type": "application/xml" }, (isSerializableHeaderValue(input.BypassGovernanceRetention) && {
        "x-amz-bypass-governance-retention": input.BypassGovernanceRetention.toString(),
    })), (isSerializableHeaderValue(input.MFA) && { "x-amz-mfa": input.MFA })), (isSerializableHeaderValue(input.RequestPayer) && { "x-amz-request-payer": input.RequestPayer }));
    let resolvedPath = "/{Bucket}";
    if (input.Bucket !== undefined) {
...
exports.serializeAws_restXmlGetObjectCommand = async (input, context) => {
    const headers = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ "Content-Type": "" }, (isSerializableHeaderValue(input.IfMatch) && { "If-Match": input.IfMatch })), (isSerializableHeaderValue(input.IfModifiedSince) && {
    ...
    const query = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ "x-id": "GetObject" }, (input.PartNumber !== undefined && { partNumber: input.PartNumber.toString() })), (input.ResponseCacheControl !== undefined && { "response-cache-control": input.ResponseCacheControl })), (input.ResponseContentDisposition !== undefined && {
...
exports.serializeAws_restXmlListPartsCommand = async (input, context) => {
    ...
    const query = Object.assign(Object.assign(Object.assign({ "x-id": "ListParts" }, (input.MaxParts !== undefined && { "max-parts": input.MaxParts.toString() })), (input.PartNumberMarker !== undefined && { "part-number-marker": input.PartNumberMarker.toString() })), (input.UploadId !== undefined && { uploadId: input.UploadId }));
    let body;
    const { hostname, protocol = "https", port } = await context.endpoint();
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restXmlPutBucketVersioningCommand = async (input, context) => {
    const headers = Object.assign(Object.assign({ "Content-Type": "application/xml" }, (isSerializableHeaderValue(input.ContentMD5) && { "Content-MD5": input.ContentMD5 })), (isSerializableHeaderValue(input.MFA) && { "x-amz-mfa": input.MFA }));
    let resolvedPath = "/{Bucket}";
    if (input.Bucket !== undefined) {
        const labelValue = input.Bucket;
        if (labelValue.length <= 0) {
...
exports.serializeAws_restXmlSelectObjectContentCommand = async (input, context) => {
    const headers = Object.assign(Object.assign(Object.assign({ "Content-Type": "application/xml" }, (isSerializableHeaderValue(input.SSECustomerAlgorithm) && {
        "x-amz-server-side-encryption-customer-algorithm": input.SSECustomerAlgorithm,
    })), (isSerializableHeaderValue(input.SSECustomerKey) && {
        "x-amz-server-side-encryption-customer-key": input.SSECustomerKey,
    })), (isSerializableHeaderValue(input.SSECustomerKeyMD5) && {
...
exports.serializeAws_restXmlUploadPartCopyCommand = async (input, context) => {
    const headers = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ "Content-Type": "" }, (isSerializableHeaderValue(input.CopySource) && { "x-amz-copy-source": input.CopySource })), (isSerializableHeaderValue(input.CopySourceIfMatch) && {
        "x-amz-copy-source-if-match": input.CopySourceIfMatch,
    })), (isSerializableHeaderValue(input.CopySourceIfModifiedSince) && {
        "x-amz-copy-source-if-modified-since": smithy_client_1.dateToUtcString(input.CopySourceIfModifiedSince).toString(),
    })), (isSerializableHeaderValue(input.CopySourceIfNoneMatch) && {
    ...
    const query = Object.assign(Object.assign({ "x-id": "UploadPartCopy" }, (input.PartNumber !== undefined && { partNumber: input.PartNumber.toString() })), (input.UploadId !== undefined && { uploadId: input.UploadId }));
    let body;
    const { hostname, protocol = "https", port } = await context.endpoint();
    return new protocol_http_1.HttpRequest({
        protocol,
