            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, AsyncStorage.getItem(oldKey)];
                    case 4:
                        item = _c.sent();
                        return [4 /*yield*/, AsyncStorage.setItem(newKey, item)];
                    case 5:
                        _c.sent();
                        return [4 /*yield*/, AsyncStorage.removeItem(oldKey)];
                    case 6:
                        _c.sent();
                        ulid = newUlid;
                        return [3 /*break*/, 8];
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, AsyncStorage.multiRemove(keysForCollectionEntries)];
                    case 15:
                        _c.sent();
                        _c.label = 16;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, AsyncStorage.multiGet(allItemsKeys)];
                    case 1:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                AsyncStorage.multiRemove(keysToDeleteArray, function (errors) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                AsyncStorage.multiSet(entriesToSet, function (errors) {
                                    if (errors && errors.length > 0) {
                                        reject(errors);
                                    }
                                    else {
