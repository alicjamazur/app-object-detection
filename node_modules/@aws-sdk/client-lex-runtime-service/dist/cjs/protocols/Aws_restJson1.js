...
exports.serializeAws_restJson1DeleteSessionCommand = async (input, context) => {
    const headers = {
        "Content-Type": "",
    };
...
exports.serializeAws_restJson1GetSessionCommand = async (input, context) => {
    const headers = {
        "Content-Type": "",
    };
    let resolvedPath = "/bot/{botName}/alias/{botAlias}/user/{userId}/session";
    ...
    const query = Object.assign({}, (input.checkpointLabelFilter !== undefined && { checkpointLabelFilter: input.checkpointLabelFilter }));
    let body;
    const { hostname, protocol = "https", port } = await context.endpoint();
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1PostContentCommand = async (input, context) => {
...
exports.serializeAws_restJson1PostTextCommand = async (input, context) => {
    const headers = {
...
exports.serializeAws_restJson1PutSessionCommand = async (input, context) => {
...
exports.deserializeAws_restJson1DeleteSessionCommand = async (output, context) => {
...
const deserializeAws_restJson1DeleteSessionCommandError = async (output, context) => {
    ...
    switch (errorCode) {
        ...
        case "com.amazonaws.lexruntimeservice#ConflictException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1ConflictExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "InternalFailureException":
        case "com.amazonaws.lexruntimeservice#InternalFailureException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1InternalFailureExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "LimitExceededException":
        case "com.amazonaws.lexruntimeservice#LimitExceededException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1LimitExceededExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
...
exports.deserializeAws_restJson1GetSessionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
exports.deserializeAws_restJson1PostContentCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
const deserializeAws_restJson1PostContentCommandError = async (output, context) => {
    ...
    switch (errorCode) {
        ...
        case "com.amazonaws.lexruntimeservice#BadGatewayException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1BadGatewayExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "BadRequestException":
        case "com.amazonaws.lexruntimeservice#BadRequestException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1BadRequestExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
        ...
        case "com.amazonaws.lexruntimeservice#DependencyFailedException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1DependencyFailedExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "InternalFailureException":
        case "com.amazonaws.lexruntimeservice#InternalFailureException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1InternalFailureExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
        ...
        case "com.amazonaws.lexruntimeservice#LoopDetectedException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1LoopDetectedExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "NotAcceptableException":
        case "com.amazonaws.lexruntimeservice#NotAcceptableException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1NotAcceptableExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "NotFoundException":
        case "com.amazonaws.lexruntimeservice#NotFoundException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1NotFoundExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
        ...
        case "com.amazonaws.lexruntimeservice#RequestTimeoutException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1RequestTimeoutExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        case "UnsupportedMediaTypeException":
        case "com.amazonaws.lexruntimeservice#UnsupportedMediaTypeException":
            response = Object.assign(Object.assign({}, (await deserializeAws_restJson1UnsupportedMediaTypeExceptionResponse(parsedOutput, context))), { name: errorCode, $metadata: deserializeMetadata(output) });
            break;
        default:
            const parsedBody = parsedOutput.body;
            errorCode = parsedBody.code || parsedBody.Code || errorCode;
...
exports.deserializeAws_restJson1PostTextCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
exports.deserializeAws_restJson1PutSessionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 400) {
...
const deserializeAws_restJson1genericAttachmentList = (output, context) => {
    return (output || []).map((entry) => deserializeAws_restJson1GenericAttachment(entry, context));
};
...
const deserializeAws_restJson1IntentSummaryList = (output, context) => {
    return (output || []).map((entry) => deserializeAws_restJson1IntentSummary(entry, context));
};
const deserializeAws_restJson1listOfButtons = (output, context) => {
    return (output || []).map((entry) => deserializeAws_restJson1Button(entry, context));
};
