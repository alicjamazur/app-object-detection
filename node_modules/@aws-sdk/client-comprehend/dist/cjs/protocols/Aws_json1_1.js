...
const serializeAws_json1_1BatchDetectDominantLanguageRequest = (input, context) => {
    return Object.assign({}, (input.TextList !== undefined && { TextList: serializeAws_json1_1StringList(input.TextList, context) }));
};
const serializeAws_json1_1BatchDetectEntitiesRequest = (input, context) => {
    return Object.assign(Object.assign({}, (input.LanguageCode !== undefined && { LanguageCode: input.LanguageCode })), (input.TextList !== undefined && { TextList: serializeAws_json1_1StringList(input.TextList, context) }));
};
