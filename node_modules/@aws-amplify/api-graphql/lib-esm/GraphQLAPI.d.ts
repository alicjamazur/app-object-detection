import Observable from '@aws-amplify/api-graphql/lib-esm/node_modules/zen-observable-ts';
import { GraphQLOptions, GraphQLResult } from '@aws-amplify/api-graphql/lib-esm/types';
